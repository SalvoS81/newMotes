...
router.register(r'sequenzariposi', views.SequenzaRiposiViewSet)
router.register(r'lavoratori', views.LavoratoreViewSet)
router.register(r'linea', views.LineaViewSet)
router.register(r'turno', views.TurnoViewSet)
router.register(r'matrice', views.MatriceViewSet)
